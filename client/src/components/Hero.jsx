...
const Hero = () => {
  ...
  return (
    <section className="relative bg-gradient-to-r from-pink-50 to-purple-50 py-16 px-4 sm:px-6 lg:px-8 overflow-hidden pt-40">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center">
        {/* Left Content */}
        <div className="lg:w-1/2 lg:pr-12 mb-12 lg:mb-0 relative z-10">
          {/* Subheading */}
          <p className="text-lg font-light text-gray-600 mb-2">When your</p>
